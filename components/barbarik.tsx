      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div className="p-4">
          <p className="text-base text-gray-900 leading-relaxed  mb-4 mt-2">
            Long before Kurukshetra thundered with conches and chariots, there
            lived a mighty rakshasa-prince named{" "}
            <strong> Ghatotkacha, son of Bhima and Hidimbi.</strong> In the far
            east, he married{" "}
            <strong>
              {" "}
              Maurvi (Ahilavati), the famed daughter of the asura Mura.
            </strong>{" "}
            Their child arrived like a streak of dawn—broad-chested,
            bright-eyed, crowned with bristling hair. Seeing those wild locks,
