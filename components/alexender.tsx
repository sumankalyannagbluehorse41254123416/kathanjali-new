  ...
  return (
    <div className="w-full lg:max-w-2xl mt-8">
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {/* CONTENT */}
        <div className="p-4">
          <p className="text-base text-gray-900 leading-relaxed mb-2 mt-4">
            After crossing rivers, razing empires, and renaming cities after
            himself, Alexander of Macedon arrived in Corinth, crowned not by
            war, but by praise.
          </p>
