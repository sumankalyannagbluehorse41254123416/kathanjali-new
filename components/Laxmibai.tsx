...
export default function Laxmibai() {
    /* ---------- POST STATE ---------- */
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div className="p-4">
          <p className="text-base text-gray-900 leading-relaxed mb-2">
            The forests of Jungle Mahal were restless. The wind carried whispers
            of revolt, and in the heart of Midnapore, the earth seemed to
            tremble under the weight of injustice. In that age of despair, when
            the East India Company bled farmers and tribals with merciless
            taxes, a queen rose—not from legend, but from flesh and blood. Her
            name was Rani Shiromani of Karnagarh.
          </p>
