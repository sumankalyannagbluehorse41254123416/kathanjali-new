  ...
  return (
    <div className="max-w-2xl  mt-8">
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {/* CONTENT */}
        <div className="p-4">
          <p className="text-base text-gray-900 leading-relaxed mb-2 font-[600]">
            The Untold Chapter of Kohima, 1944
          </p>
          <p className="text-base text-gray-900 leading-relaxed mb-2">
            It was April 1944
          </p>
          <p className="text-base text-gray-900 leading-relaxed mb-2">The hills of Kohima, draped in early monsoon mist, were calm — until the earth began to shake with artillery fire.</p>
          <Link
            href="/indiapost"
